      ...
      <div className="max-w-6xl mx-auto py-12 px-4">
        ...
        <div className="p-8 mb-12">
          <div className="text-center mb-8">
            <h2 className="text-3xl font-bold text-navy mb-4">Your Generosity Makes a Difference</h2>
        ...
        {/* Why We Give Section */}
        <div className="mb-12">
          <h2 className="text-3xl font-bold text-navy mb-6 text-center">Why We Give</h2>
          <div className="grid md:grid-cols-2 gap-8">
            <div className="space-y-6">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className="text-xl font-semibold text-navy mb-2">Worship & Obedience</h3>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className="text-xl font-semibold text-navy mb-2">Supporting Ministry</h3>
            ...
            <div className="space-y-6">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className="text-xl font-semibold text-navy mb-2">Building Community</h3>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className="text-xl font-semibold text-navy mb-2">Advancing God's Kingdom</h3>
        ...
        <div className="mb-12">
          <h2 className="text-3xl font-bold text-navy mb-8 text-center">Ways to Give</h2>
          <div className="grid md:grid-cols-3 gap-6">
            {/* Online Giving */}
            <div className="bg-gradient-to-br from-navy to-[#4a5ba8] text-white rounded-lg p-6 text-center hover:shadow-lg transition-shadow">
              ...
              <a href='./contact' className="bg-white text-navy px-6 py-2 rounded-lg font-semibold hover:bg-gray-100 transition-colors">
                Give Online
              </a>
            </div>
            ...
            <div className="flip-card">
              <div className={`flip-card-inner ${showBankDetails ? 'flipped' : ''}`}> 
                ...
                <div className="flip-card-front card-content">
                  ...
                  <h3 className="text-xl font-semibold text-navy mb-3">Bank Transfer</h3>
                  <p className="text-gray-700 mb-4">Make a direct bank transfer to our church account</p>
                  <button
                    className="bg-navy text-white px-6 py-2 rounded-lg font-semibold hover:bg-navy/90 transition-colors"
                ...
                <div className="flip-card-back card-content">
                  <h4 className="text-lg font-bold text-navy mb-2">Church Bank Details</h4>
                  ...
                  <button
                    className="bg-navy text-white px-6 py-2 rounded-lg font-semibold hover:bg-navy/90 transition-colors mt-4"
            ...
            <div className="p-6 text-center">
              ...
              <h3 className="text-xl font-semibold text-navy mb-3">In-Person Giving</h3>
              <p className="text-gray-700 mb-4">Bring your offering during church services or events</p>
              <a href='/about' className="bg-navy text-white px-6 py-2 rounded-lg font-semibold hover:bg-navy/90 transition-colors">
                Visit Us
              </a>
            </div>
          </div>
        ...
        {/* Tithing Information */}
        <div className="mb-12">
          <h2 className="text-3xl font-bold text-navy mb-6 text-center">Understanding Tithing</h2>
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div>
              <h3 className="text-2xl font-semibold text-navy mb-4">What is a Tithe?</h3>
              ...
              <blockquote className="border-l-4 border-gold pl-4 italic text-gray-600 mb-4">
            ...
            <div className="bg-gradient-to-br from-navy/10 to-gold/10 rounded-lg p-6">
              <h4 className="text-xl font-semibold text-navy mb-4">Benefits of Tithing</h4>
        ...
        {/* Special Offerings */}
        <div className="mb-12">
          <h2 className="text-3xl font-bold text-navy mb-6 text-center">Special Offerings</h2>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="p-6">
              <h3 className="text-xl font-semibold text-navy mb-3">Youth Ministry</h3>
              <p className="text-gray-700 mb-4">Support youth programs, camps, and leadership development initiatives.</p>
              <button className="text-navy font-semibold hover:underline">Learn More →</button>
            </div>
            <div className="p-6">
              <h3 className="text-xl font-semibold text-navy mb-3">Community Outreach</h3>
              <p className="text-gray-700 mb-4">Help us reach out to the community with food drives and assistance programs.</p>
              <button className="text-navy font-semibold hover:underline">Learn More →</button>
            </div>
            <div className="p-6">
              <h3 className="text-xl font-semibold text-navy mb-3">Building Fund</h3>
        ...
        {/* Contact Section */}
        <div className="bg-gradient-to-br from-navy to-[#4a5ba8] text-white rounded-lg p-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              href="/contact"
              className="bg-white text-navy px-8 py-3 rounded-lg font-semibold hover:bg-gray-100 transition-colors inline-block"
            >
              Contact Us
            </a>
