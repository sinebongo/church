...
export const additionalleaders = [
    { role: "Southern Mission Circuit Secretary", name: "Kabelo Phanya", img: "/kabelo.jpg" },
    ...
    { role: "Soweto Circuit Secretary", name: "Ikageng Mogatusi", img: "/ikageng.jpg" },
];
...
export const CATEGORIES = ["All", "Youth", "Worship", "Outreach", "Study", "Prayer", "Children", "Music", "Men"];
